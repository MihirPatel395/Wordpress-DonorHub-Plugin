...
<body>
    <div class="donate">
        ...
        $output .= "<h2>Campain Name: {$campain_name}</h2>";
        $output .= "<h2>Description: {$description}</h2>";
        $output .= "<h2>Goal: {$goal}</h2>";
        echo $output;
        ?>
    ...
    <section id="confirm">
        <h2>Thank You!</h2>
        <p>
            Your <span class="amount">₹25</span> donation will donate to <strong><?php echo $campain_name ?></strong>!
        </p>
    </section>
