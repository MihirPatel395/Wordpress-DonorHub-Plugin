...
<head>
  ...
  <script>
    ...
    if (isset($_POST['submit'])) { ?>
      alert("Campain Add Successfully...");
    <?php } ?>
  ...
  <form method="post">
    <table>
      <tr>
        <td class="first_column">
          <pre id="cname">Campain Name</pre>
        </td>
        <td>
          <input type="text" name="campainname" id="CustomAmountText" />
          <br />
          <p>This text appears as a campain name.</p>
        </td>
      </tr>
      <tr>
        <td class="first_column">
        ...
        <td>
          <textarea id="CustomAmountText" name="CustomAmountText" rows="4" cols="50"></textarea>
          <br />
          <p>
            This text appears as a campain description.You can add information
            about campain .
          </p>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="radio" id="multileveldonation" name="donationOption" onclick="showSetDonation(0)" />
          <label for="multileveldonation">Multi-level Doantion</label>
          <input type="radio" id="setdonation" name="donationOption" onclick="showSetDonation(1)" checked />
    ...
    <table id="SetDonationBlock">
      <tr>
        ...
        <td>
          ...
          <div class="editablediv" contenteditable="true" style="
              width: 100px;
    ...
    <table>
      <tr>
        ...
        <td>
          <input type="radio" id="enabled" name="customamount" onclick="showCustomAmtBlock(1)" checked />
          <label for="multileveldonation">Enabled</label>
          <input type="radio" id="disabled" name="customamount" onclick="showCustomAmtBlock(0)" />
    ...
    <table id="CustomAmountEnabledBlock">
      <tr>
        ...
        <td>
          ...
          <div name="min_amount" class="editablediv" contenteditable="true" style="
              width: 100px;
              border-top-right-radius: 2px;
              border-bottom-right-radius: 2px;
              margin-left: -4px;
          ...
          <br />
          Maximum Amount
          <div name="max_amount" class="editablediv" style="
              width: 20px;
              border-top-left-radius: 2px;
              border-bottom-left-radius: 2px;
              ">
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          <div class="editablediv" contenteditable="true" style="width: 150px; border-radius: 2px">
            Conation Level
          </div>
        </td>
      </tr>
